...
def load_scanobjectnn_data(partition):
    ...
    # h5_name = r'E:\Desktop\Code\pointmlp\classification_ScanObjectNN\data\h5_files\main_split\training_objectdataset_augmentedrot_scale75.h5'
...
class ScanObjectNN(Dataset):
    ...
    def __getitem__(self, item):
        ...
        #     pointcloud = add_noisedata(pointcloud, num_noise=100)
